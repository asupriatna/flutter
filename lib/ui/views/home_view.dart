...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool keyboardOpen = MediaQuery.of(context).viewInsets.bottom>0; // to check keyboard open
              ...
              children: <Widget>[
                TextFieldWidget(
                  ...
                  onChanged: (value){
                    ...
                    print("print model"+model.isValid);
                  },
                ),
                SizedBox(
                    height: 10.0,
                ...
                Column(
                  ...
                  children: <Widget> [
                    TextFieldWidget(
                        ...
                        suffixIconData:  model.isVisible? Icons.visibility
